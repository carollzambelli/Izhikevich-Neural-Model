...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone V" DIRECTION="ADD" OPTIMIZE="SPEED" PIPELINE=7 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=8 WIDTH_MAN=23 clk_en clock dataa datab result
...
module  soma_altbarrel_shift_ltd
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //soma_altbarrel_shift_ltd
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  soma_altbarrel_shift_aeb
	( 
	data,
	distance,
	result) ;
	...
	assign
		...
		sel_w = {distance[4:0]},
		smux_w = {((({26{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[113:104], pad_w[15:0]}) | ({26{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[129:120]})) | ({26{(~ sel_w[4])}} & sbit_w[129:104])), ((({26{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[95:78], pad_w[7:0]}) | ({26{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[103:86]})) | ({26{(~ sel_w[3])}} & sbit_w[103:78])), ((({26{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[73:52], pad_w[3:0]}) | ({26{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[77:56]})) | ({26{(~ sel_w[2])}} & sbit_w[77:52])), ((({26{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[49:26], pad_w[1:0]}) | ({26{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[51:28]})) | ({26{(~ sel_w[1])}} & sbit_w[51:26])), ((({26{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[24:0], pad_w[0]}) | ({26{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[25:1]})) | ({26{(~ sel_w[0])}} & sbit_w[25:0]))};
endmodule //soma_altbarrel_shift_aeb
...
module  soma_altpriority_encoder_3e8
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //soma_altpriority_encoder_3e8
...
endmodule //soma_altpriority_encoder_6e8
...
endmodule //soma_altpriority_encoder_be8
...
module  soma_altpriority_encoder_3v7
	...
	assign
		q = {data[1]};
endmodule //soma_altpriority_encoder_3v7
...
endmodule //soma_altpriority_encoder_6v7
...
endmodule //soma_altpriority_encoder_bv7
...
endmodule //soma_altpriority_encoder_r08
...
endmodule //soma_altpriority_encoder_rf8
...
endmodule //soma_altpriority_encoder_qb6
...
module  soma_altpriority_encoder_nh8
	...
	assign
		q = {(~ data[0])},
		zero = (~ (data[0] | data[1]));
endmodule //soma_altpriority_encoder_nh8
...
endmodule //soma_altpriority_encoder_qh8
...
endmodule //soma_altpriority_encoder_vh8
...
endmodule //soma_altpriority_encoder_fj8
...
module  soma_altpriority_encoder_n28
	...
	assign
		q = {(~ data[0])};
endmodule //soma_altpriority_encoder_n28
...
endmodule //soma_altpriority_encoder_q28
...
endmodule //soma_altpriority_encoder_v28
...
endmodule //soma_altpriority_encoder_f48
...
endmodule //soma_altpriority_encoder_e48

//synthesis_resources = lpm_add_sub 14 lpm_compare 1 reg 282 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  soma_altfp_add_sub_3ij
	( 
	clk_en,
	clock,
	dataa,
...
`endif
	...
	soma_altbarrel_shift_ltd   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	soma_altbarrel_shift_aeb   rbarrel_shift
	( 
	.data({man_smaller_dffe13_wo, {2{1'b0}}}),
	.distance(rshift_distance_dffe13_wo),
	.result(wire_rbarrel_shift_result));
	soma_altpriority_encoder_qb6   leading_zeroes_cnt
	( 
	.data({man_add_sub_res_mag_dffe21_wo[25:1], 1'b1, {6{1'b0}}}),
	.q(wire_leading_zeroes_cnt_q));
	soma_altpriority_encoder_e48   trailing_zeros_cnt
	( 
...
endmodule //soma_altfp_add_sub_3ij
//VALID FILE
...
// Retrieval info: GEN_FILE: TYPE_NORMAL soma.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL soma.inc FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL soma.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL soma.bsf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL soma_inst.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL soma_bb.v TRUE
